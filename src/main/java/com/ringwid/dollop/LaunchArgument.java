...
public class LaunchArgument {
    ...
    private String auctionFileFolder;
    ...
    public String getAuctionFileFolder() {
        return auctionFileFolder;
    }

    public void setAuctionFileFolder(String auctionFileFolder) {
        this.auctionFileFolder = auctionFileFolder;
    }
